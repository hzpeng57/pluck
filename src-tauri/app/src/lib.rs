...
pub fn run() {
    ...
    let builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::conflict_list_cmd,
            commands::conflict_detail_cmd,
            commands::conflict_resolve_text_cmd,
            commands::conflict_take_stage_cmd,
            commands::conflict_delete_path_cmd,
